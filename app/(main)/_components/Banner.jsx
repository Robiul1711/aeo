  ...
  return (
    <section className="relative w-full h-[85vh] md:h-screen flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-8 px-6 text-center select-none">
        ...
        {/* Book Now Button */}
        <button className="px-8 py-3.5 bg-white text-black hover:bg-white/95 rounded-[12px] font-outfit text-[17px] font-semibold tracking-wider transition-all duration-300 hover:scale-[1.05] active:scale-[0.95] shadow-lg border-none cursor-pointer">
          Book Now
        </button>
      </div>

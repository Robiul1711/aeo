...
const SuccessContent = () => {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetBookingByReferenceQuery(reference, {
    skip: !reference,
  });
  ...
  if (isError || !booking) {
    return (
      <div className="flex flex-col items-center justify-center py-32 gap-4">
        ...
        <h1 className="text-white font-playfair text-3xl font-normal">
          Payment Successful!
        </h1>
        <p className="text-white/50 font-outfit text-[15px]">
          Reference:{" "}
          <span className="text-primary font-semibold">{reference}</span>
        </p>
        <Link
          href="/events"
          className="mt-4 text-primary hover:underline font-outfit font-semibold"
        >
          Browse More Events
        </Link>
      </div>
    ...
    <div className="flex flex-col items-center gap-8 w-full max-w-2xl mx-auto">
      ...
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <p className="text-white/50 font-outfit text-[15px] max-w-md leading-relaxed">
          Your tickets have been booked and payment was successful. A
      ...
      <div className="bg-primary/5 border border-primary/25 rounded-[16px] px-6 py-4 flex flex-col sm:flex-row items-center gap-3 w-full select-none">
        <div className="flex flex-col">
          <span className="text-white/40 font-outfit text-[12px] uppercase tracking-widest">
            Booking Reference
          </span>
        ...
        <div className="sm:ml-auto flex flex-col items-start sm:items-end">
          ...
          <span
            className={`font-outfit font-semibold text-[15px] mt-1 capitalize ${
      ...
      <div className="w-full bg-[#111111]/60 border border-white/5 rounded-[24px] p-6 sm:p-8 flex flex-col gap-6 shadow-lg">
        ...
        <div className="flex flex-col gap-4 border-b border-white/5 pb-6">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-white font-outfit font-semibold text-[15px]">
                  {booking.event_title}
                </p>
                <p className="text-white/50 font-outfit text-[13px] mt-0.5">
        ...
        <div className="flex flex-col gap-4 border-b border-white/5 pb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/70 font-outfit text-[14px]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex justify-between items-center">
            <span className="text-white/50 font-outfit text-[14px]">
              Subtotal
            </span>
            <span className="text-white/80 font-outfit text-[15px] font-medium">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-white/80 font-outfit text-[15px] font-medium">
              ${booking.service_charge_total?.toFixed(2)}
            </span>
          </div>
          <div className="border-t border-white/5 my-1" />
          <div className="flex justify-between items-center">
            <span className="text-white font-outfit font-semibold text-[17px]">
              Total Paid
            </span>
            <span className="text-primary font-outfit font-bold text-[20px]">
              ...
              {(
                ...
                (booking.service_charge_total || 0)
              ).toFixed(2)}
            </span>
          </div>
        </div>

...
const PrivacyPolicyPageClient = () => {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-10">
        ...
        {!isLoading && !isError && pageData?.content?.description && (
          <div 
            ...
            className=" text-secondary-gray text-[15px] sm:text-[16px] leading-relaxed flex flex-col gap-4 [&>h2]:text-white [&>h2]:text-[22px] [&>h2]:font-semibold [&>h2]:font-outfit [&>h2]:mt-4 [&>h2]:mb-2 [&>p]:text-secondary-gray [&>p]:leading-relaxed [&>a]:text-primary [&>a]:underline [&>a]:hover:text-primary/80"
          />
        )}
